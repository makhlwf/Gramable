    ...
    public void createUpdateUI(int currentAccount) {
        ...
        updateLayout.setOnClickListener(v -> {
            if (updateLayoutIcon.getIcon() == MediaActionDrawable.ICON_DOWNLOAD) {
                ...
                if (file != null) {
                    AndroidUtilities.openForView(file, "Gramable.apk", "application/vnd.android.package-archive", activity, null, false);
                }
            }
        });
        ...
        updateTextView.setText(LocaleController.getString(ApplicationLoader.isBetaBuild() ? R.string.AppUpdateBeta : R.string.AppUpdate), false);
    ...
    public void updateAppUpdateViews(int currentAccount, boolean animated) {
        ...
        if (ApplicationLoader.applicationLoaderInstance.getUpdate() != null) {
            ...
            if (file != null && file.exists()) {
                ...
                setUpdateText(LocaleController.getString(ApplicationLoader.isBetaBuild() ? R.string.AppUpdateBeta : R.string.AppUpdate), animated);
            }
