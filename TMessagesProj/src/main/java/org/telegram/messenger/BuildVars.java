...
public class BuildVars {
    ...
    public static int APP_ID = 4834654;
    public static String APP_HASH = "832240bfc5406d2e9e3c065b4975447b";

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "AIzaSyDqt8P-7F7CPCseMkOiVRgb1LY8RN1bvH8";
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=com.makhlwf.gramable";
